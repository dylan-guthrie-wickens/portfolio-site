...
const ProjectCard: FunctionComponent<{
  ...
  return (
    <div>
      ...
      {showDetail === id && (
        <div className="absolute top-0 left-0 z-10 grid w-full h-auto p-2 rounded-md bg-slate-300 text-slate-950 md:grid-cols-2 gap-x-12 dark:text-slate-100 dark:bg-slate-600">
